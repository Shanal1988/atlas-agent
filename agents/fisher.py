...
P12 LONG TERM OUTLOOK:     Does management articulate a clear 10-year destination and invest with that horizon in mind? Do shareholder letters or earnings calls describe where the business is going, not just where it has been? The primary long-term risk is misanalysing the destination, not short-term volatility. (evidence: invest through downturns, explicit destination language in shareholder letters, capex decisions that only make sense at long horizons)
